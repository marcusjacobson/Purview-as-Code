...
| Insider Risk Management | [`governance-foundation/insider-risk-management.md`](governance-foundation/insider-risk-management.md) | [`irm/policies.yaml`](../../data-plane/irm/policies.yaml), [`irm/entity-lists.yaml`](../../data-plane/irm/entity-lists.yaml) (parked, ADR 0064) | [`Deploy-IRMPolicies.ps1`](../../scripts/Deploy-IRMPolicies.ps1), [`Deploy-IRMEntityLists.ps1`](../../scripts/Deploy-IRMEntityLists.ps1) (parked) |
